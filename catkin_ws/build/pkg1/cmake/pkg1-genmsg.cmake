...
set(MSG_I_FLAGS "-Ipkg1:/home/ravi/robotics/catkin_ws/src/pkg1/msg;-Istd_msgs:/opt/ros/kinetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/ravi/robotics/catkin_ws/src/pkg1/msg/Num.msg" NAME_WE)
add_custom_target(_pkg1_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "pkg1" "/home/ravi/robotics/catkin_ws/src/pkg1/msg/Num.msg" ""
)
...
_generate_msg_cpp(pkg1
  "/home/ravi/robotics/catkin_ws/src/pkg1/msg/Num.msg"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/pkg1)
  install(CODE "execute_process(COMMAND \"/usr/bin/python\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/pkg1\")")
  # install generated code
  install(
