...
if("TRUE" STREQUAL "TRUE")
  set(tf_SOURCE_PREFIX /home/ravi/robotics/catkin_tf/src/tf)
  set(tf_DEVEL_PREFIX /home/ravi/robotics/catkin_tf/devel/.private/tf)
  set(tf_INSTALL_PREFIX "")
  set(tf_PREFIX ${tf_DEVEL_PREFIX})
else()
  set(tf_SOURCE_PREFIX "")
  set(tf_DEVEL_PREFIX "")
  set(tf_INSTALL_PREFIX /home/ravi/robotics/catkin_tf/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'tf' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'ravi <ravi@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'tf' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ravi/robotics/catkin_tf/src/tf/${idir}'.  Ask the maintainer 'ravi <ravi@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/ravi/robotics/catkin_tf/devel/.private/tf/lib;/home/ravi/robotics/catkin_tf/devel/lib;/home/ravi/robotics/catkin_talk_listen/devel/lib;/home/ravi/robotics/catkin_ws1/devel/lib;/opt/ros/kinetic/lib)
